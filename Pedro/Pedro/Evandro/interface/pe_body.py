...
from Pedro.Evandro.auxiliar import PSO2 as pso
from Pedro.Evandro.interface import resultado as res
from Pedro.Evandro.interface import resultado_est as res_est
