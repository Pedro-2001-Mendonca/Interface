...
from Pedro.Evandro.auxiliar import load_excel_file as excel

from Pedro.Evandro.classes import experiment_class as ec
from Pedro.Evandro.auxiliar import synchronization as sync
from Pedro.Evandro.db import db_experiment as db
